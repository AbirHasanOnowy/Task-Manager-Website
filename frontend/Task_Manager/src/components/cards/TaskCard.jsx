...
const TaskCard = ({ title, description, priority,
    ...
    return (
        <div
            ...
            <div className={`px-4 border-l-[3px] ${status === "In Progress" ? "border-cyan-500" :
                ...
                <p className='text-[13px] text-gray-700/80 fonr-medium mt-2 mb-2 leading-[18px]'>
                    Task Done:{' '}
                ...
                <div className='flex items-center justify-between mt-3'>
                    ...
                    {attachmentCount > 0 && (
                        <div className='flex items-center gap-2 bg-blue-50 px-2.5 py-1.5 rounded-lg'>
                            ...
                            <span className='text-gray-900 text-xs'>{attachmentCount}</span>
                        </div>
                    )}
                </div>
            </div>
